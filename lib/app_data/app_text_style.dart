...
class AppTextStyle {
  ...
  static TextStyle font30QuicksandBoldRedTextStyle = GoogleFonts.quicksand(
      color: AppColors.lightRed, fontSize: 30, fontWeight: FontWeight.w700);
  ...
  static TextStyle font18QuicksandBoldWhite60TextStyle = GoogleFonts.quicksand(
      ...
      fontSize: 18,
      fontWeight: FontWeight.w700);
  static TextStyle font18QuicksandBoldLightBlue60TextStyle =
      GoogleFonts.quicksand(
          color: AppColors.starProgressColor.withOpacity(0.60),
          fontSize: 18,
          fontWeight: FontWeight.w700);
  ...
  static TextStyle font18QuicksandBoldRedTextStyle = GoogleFonts.quicksand(
      color: AppColors.lightRed, fontSize: 18, fontWeight: FontWeight.w700);
  ...
  static TextStyle font20AsapMediumRedTextStyle = GoogleFonts.asap(
      color: AppColors.lightRed, fontSize: 20, fontWeight: FontWeight.w500);
  ...
  static TextStyle font18AsapRegularWhite17TextStyle = GoogleFonts.asap(
      ...
      fontSize: 18,
      fontWeight: FontWeight.w400);
  static TextStyle font18AsapBoldLightGreenTextStyle = GoogleFonts.asap(
      color: AppColors.tourLobbyTextColor,
      fontSize: 18,
      fontWeight: FontWeight.w700);
  ...
  static TextStyle font18AsapRegularRedTextStyle = GoogleFonts.asap(
      color: AppColors.lightRed, fontSize: 18, fontWeight: FontWeight.w400);
  ...
  static TextStyle font18AsapRegularGreenTextStyle = GoogleFonts.asap(
      color: AppColors.tourLobbyTextColor,
      fontSize: 18,
      fontWeight: FontWeight.w400);
  ...
  static TextStyle font17AsapSemiBoldGreenTextStyle = GoogleFonts.asap(
      color: AppColors.tourLobbyTextColor,
      fontSize: 17,
  ...
  static TextStyle font16AsapAppGrayTextStyle =
      GoogleFonts.asap(color: AppColors.appGray, fontSize: 16);
  ...
  static TextStyle font16AsapMediumBlueDarkTextStyle = GoogleFonts.asap(
      color: AppColors.appGray, fontSize: 16, fontWeight: FontWeight.w500);
  static TextStyle font16AsapRegularLightGreenTextStyle = GoogleFonts.asap(
      color: AppColors.tourLobbyTextColor,
      fontSize: 16,
      fontWeight: FontWeight.w400);
  static TextStyle font16AsapRegularLightRed80TextStyle = GoogleFonts.asap(
      color: AppColors.lightRed.withOpacity(0.80),
      fontSize: 16,
      fontWeight: FontWeight.w400);
  ...
  static TextStyle font16AsapBoldLightBlueTextStyle = GoogleFonts.asap(
      color: AppColors.starProgressColor,
      fontSize: 16,
  ...
  static TextStyle font14AsapRegularYellowTextStyle = GoogleFonts.asap(
      color: AppColors.starColor, fontSize: 14, fontWeight: FontWeight.w400);
  static TextStyle font14AsapRegularBlueDarkTextStyle = GoogleFonts.asap(
  ...
  static TextStyle font14AsapRegularGreenTextStyle = GoogleFonts.asap(
      color: AppColors.clockingLogTextColor,
      fontSize: 14,
      fontWeight: FontWeight.w400);

  ///Opensans
  static TextStyle font36OpenSansExtraboldLightGreenWithShadowTextStyle =
      GoogleFonts.openSans(
          color: AppColors.bottomBarCardsColor,
          fontSize: 36,
          shadows: [
            Shadow(
              color: AppColors.whiteTextShadow.withOpacity(1.0),
  ...
  static TextStyle font30OpenSansExtraboldRedTextStyle = GoogleFonts.openSans(
      color: AppColors.lightRed, fontSize: 30, fontWeight: FontWeight.w800);
  static TextStyle font30OpenSansExtraboldWhite30TextStyle =
      GoogleFonts.openSans(
          color: AppColors.white.withOpacity(0.30),
          fontSize: 30,
          fontWeight: FontWeight.w800);
  static TextStyle font28OpenSansExtraboldGreenTextStyle = GoogleFonts.openSans(
      color: AppColors.bottomBarCardsColor,
      fontSize: 28,
      fontWeight: FontWeight.w800);
  static TextStyle font28OpenSansExtraboldLightGreenTextStyle =
      GoogleFonts.openSans(
          color: AppColors.starProgressColor,
          fontSize: 28,
          fontWeight: FontWeight.w800);
  ...
  static TextStyle font26OpenSansExtraboldLightGreenTextStyle =
      GoogleFonts.openSans(
          color: AppColors.starProgressColor,
          fontSize: 26,
          fontWeight: FontWeight.w800);
  ...
  static TextStyle font24OpenSansExtraboldLightGreenTextStyle =
      GoogleFonts.openSans(
          color: AppColors.locProgressBarColor,
          fontSize: 24,
          fontWeight: FontWeight.w800);
  static TextStyle font24OpenSansExtraboldRedTextStyle = GoogleFonts.openSans(
      color: AppColors.lightRed, fontSize: 24, fontWeight: FontWeight.w800);
  static TextStyle font24OpenSansExtraboldGreyTextStyle = GoogleFonts.openSans(
      color: AppColors.addUserColor, fontSize: 24, fontWeight: FontWeight.w800);
  static TextStyle font24OpenSansExtraboldLightBlueTextStyle =
      GoogleFonts.openSans(
          color: AppColors.starProgressColor,
          fontSize: 24,
          fontWeight: FontWeight.w800);
  static TextStyle font22OpenSansExtraboldRedTextStyle = GoogleFonts.openSans(
      color: AppColors.lightRed, fontSize: 22, fontWeight: FontWeight.w800);
  ...
  static TextStyle font20OpenSansExtraboldPurpleTextStyle =
      GoogleFonts.openSans(
          ...
          fontSize: 20,
          fontWeight: FontWeight.w800);
  static TextStyle font18OpenSansExtraboldLightBlueTextStyle =
      GoogleFonts.openSans(
          color: AppColors.starProgressColor,
          fontSize: 18,
          fontWeight: FontWeight.w800);
  ...
  static TextStyle font18OpenSansboldWhite79TextStyle = GoogleFonts.openSans(
      ...
      fontSize: 18,
      fontWeight: FontWeight.w700);
  static TextStyle font18OpenSansboldGreenTextStyle = GoogleFonts.openSans(
      color: AppColors.bottomBarCardsColor,
      fontSize: 18,
      fontWeight: FontWeight.w700);
  static TextStyle font18OpenSansboldLightRedTextStyle = GoogleFonts.openSans(
      color: AppColors.lightRed, fontSize: 18, fontWeight: FontWeight.w700);
  static TextStyle font18OpenSansboldLightPurpleTextStyle =
      GoogleFonts.openSans(
          color: AppColors.siteActiveOvertimeColor,
          fontSize: 18,
          fontWeight: FontWeight.w700);
  static TextStyle font18OpenSansExtraBoldUnderlinePurpleTextStyle =
      GoogleFonts.openSans(
          ...
          fontWeight: FontWeight.w800);
  static TextStyle font16OpenSansBoldGreen80TextStyle = GoogleFonts.openSans(
      color: AppColors.tourLobbyTextColor.withOpacity(0.80),
      fontSize: 16,
      fontWeight: FontWeight.w700);
  static TextStyle font16OpenSansBoldGreenTextStyle = GoogleFonts.openSans(
      color: AppColors.tourLobbyTextColor,
      fontSize: 16,
      fontWeight: FontWeight.w700);
  static TextStyle font16OpenSansExtraboldLightBlue75TextStyle =
      GoogleFonts.openSans(
          color: AppColors.starProgressColor.withOpacity(0.75),
          fontSize: 16,
          fontWeight: FontWeight.w800);
